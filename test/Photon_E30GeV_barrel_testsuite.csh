...
sed 's/simevent.root/Photon_E30GeV_barrel_simevent.root/' ${CMSSW_RELEASE_BASE}/src/Validation/EcalDigis/test/EcalSimProducer.cfg >&! ${WORKDIR}/Photon_E30GeV_barrel_testsuite1.cfg
