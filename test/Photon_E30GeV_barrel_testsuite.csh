...
sed 's/EcalDigisValidation_old.root/Photon_E30GeV_barrel_EcalDigisValidation_old.root/' ${SWSOURCE}/src/Validation/EcalDigis/test/EcalDigisPlotCompare.C | sed 's/EcalDigisValidation_new.root/Photon_E30GeV_barrel_EcalDigisValidation_new.root/' | sed 's/EcalDigisPlotCompare/Photon_E30GeV_barrel_testsuite3/' >&! ${WORKDIR}/Photon_E30GeV_barrel_testsuite3.C

cp ${SWSOURCE}/src/Validation/EcalDigis/test/HistoCompare.C ${WORKDIR}

cp ${SWSOURCE}/src/Validation/EcalDigis/data/Photon_E30GeV_barrel_EcalDigisValidation.root ${WORKDIR}/Photon_E30GeV_barrel_EcalDigisValidation_old.root
