...
#sed 's/simevent.root/Photon_E30GeV_all_simevent.root/' ${CMSSW_RELEASE_BASE}/src/SimCalorimetry/EcalSimProducers/test/EcalSimProducer.cfg >&! ${WORKDIR}/Photon_E30GeV_all_testsuite1.cfg
sed 's/simevent.root/Photon_E30GeV_all_simevent.root/' ${CMSSW_RELEASE_BASE}/src/Validation/EcalDigis/test/EcalSimProducer.cfg >&! ${WORKDIR}/Photon_E30GeV_all_testsuite1.cfg
...
sed s/digis.root/Photon_E30GeV_all_digis.root\',\'file:Photon_E30GeV_all_digis001.root/ ${CMSSW_RELEASE_BASE}/src/Validation/EcalDigis/test/EcalDigisAnalysis.cfg >&! ${WORKDIR}/Photon_E30GeV_all_testsuite2.cfg
...
sed 's/EcalDigisValidation_old.root/Photon_E30GeV_all_EcalDigisValidation_old.root/' ${CMSSW_RELEASE_BASE}/src/Validation/EcalDigis/test/EcalDigisPlotCompare.C | sed 's/EcalDigisValidation_new.root/Photon_E30GeV_all_EcalDigisValidation_new.root/' | sed 's/EcalDigisPlotCompare/Photon_E30GeV_all_testsuite3/' >&! ${WORKDIR}/Photon_E30GeV_all_testsuite3.C

cp ${CMSSW_RELEASE_BASE}/src/Validation/EcalDigis/test/HistoCompare.C ${WORKDIR}

cp ${CMSSW_RELEASE_BASE}/src/Validation/EcalDigis/data/Photon_E30GeV_all_EcalDigisValidation.root ${WORKDIR}/Photon_E30GeV_all_EcalDigisValidation_old.root
